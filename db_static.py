...
def initt():
    ...
    INSERT INTO trainer VALUES(3,'Erce Can Bekture','$pbkdf2-sha256$29000$1lorxdjbe48RAiCEcI6R8g$bdDWS9JFYN4Gga7B6GOo3.9VvbQjA.C70SPX8Xf90gg',
    0.0,20,'Male',0,1);
    INSERT INTO trainer VALUES(4,'Orhan Yılmaz','$pbkdf2-sha256$29000$5hwDQMhZK8XYmxMiRGjNGQ$ffOlYGbatNOBJP8VjtFaslYTFENCxV1lQVu0iVD3M7k',
    0.0,32,'Male',0,13);
    INSERT INTO trainer VALUES(5,'Tuğçe Çağlayan','$pbkdf2-sha256$29000$AeDcm1Nqbe1da03p3TunFA$1s0awCe/99rfl4w1Ndy.SAVDlkef4DM02OA1TMviZbw',
    0.0,41,'Female',0,20);
    INSERT INTO trainer VALUES(6,'Furkan Halifeoğlu','$pbkdf2-sha256$29000$COGcU.odwxhj7P2fszam1A$Szha4E.KrZowHTE0PwanE7a8l5lAyugyvANG5rGcGnk',
    0.0,25,'Male',0,5);
    INSERT INTO trainer VALUES(7,'Berkay Türkkan','$pbkdf2-sha256$29000$LSWE8L4XQshZC8FYa40xxg$xntELIZwlB4oCxos13D8F0di9rsr25qR4hL7uRe/JNs',
    0.0,29,'Male',0,6);
    INSERT INTO trainer VALUES(8,'Savaş Cebeci','$pbkdf2-sha256$29000$0JozphQCQGjNubf2PmcMAQ$YgWvUjAwI7S36x5RiTXS5TyAvCCiP3EkHX6drpuy0cE',
    0.0,44,'Male',0,22);
    INSERT INTO trainer VALUES(9,'Testo Taylan','$pbkdf2-sha256$29000$Rsg5R6g1xnhPqRUCYGyNMQ$jkD81HPUDHf.JeGQKpzeNrguP7mR.7hkWUMpn6B9vkI',
    0.0,24,'Male',0,1);
    INSERT INTO trainer VALUES(10,'Rıza Kayaalp','$pbkdf2-sha256$29000$sNY6B2BMKUUIoZRSivF.jw$repCZuzsOwL.xUsZlS4xCsCAMhy.ZtxtE.t2f4HQfEE',
    0.0,33,'Male',0,10);



    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Chest', 'Bench Press', 'benchpress.png', 'Adjust the seat back to the upright position. Adjust the seat so that the
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Chest', 'Cable Incline Fly', 'cableinclinefly.png', 'Adjust the seat back to the upright position. Adjust the Functional
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Chest', 'Stabilizing Chest Press', 'stabilizingchestpress.png', 'This exercise targets the chest muscles, but because it is done without back
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Shoulder', 'Shoulder Press', 'shoulderpress.png', 'Adjust the seat back to one of the holes in the SHOULDER position.
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Shoulder', 'Cable Lateral Raise', 'cablelateralraise.png', 'Adjust the Functional Training Arms to a low position, about shoulder
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Shoulder', 'Shrugs', 'shrugs.png', 'Attach the straight bar to the low pulley (on some models, this may
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Shoulder', 'External Rotator', 'externalrotator.png', 'Stand beside your machine and adjust the Functional Training Arm to
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Back', 'Lat Pull Down', 'latpulldown.png', 'Adjust the seat to its lowest position. Attach the lat bar to the high
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Back', 'Low Cable Row', 'lowcablerow.png', 'Attach the straight bar to the low pulley. Sit on the floor facing the
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Back', 'Front Lat Pullover', 'fronlatpullover.png', 'Although the picture does not show this, you may need to use the
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Arm', 'Cable Arm Curl', 'cablearmcurl.png', 'Adjust the seat back to the upright position and the Functional Training Arms to their lowest position. Sit upright on the seat and grasp the
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Arm', 'Overhead Biceps Curl', 'benchpress.png', 'Attach the straight bar to the high pulley. Sit facing the machine and
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Arm', 'Triceps Pushdown', 'tricepspushdown.png', 'It is important to use the supplied length of chain on this exercise.
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Arm', 'Triceps Kickback', 'tricepskickback.png', 'Attach a single handle to a Functional Training Arm and adjust it to
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Core', 'Ab Crunch', 'abcrunch.png', 'Adjust the seat to the lowest position and the seat back to the upright
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Core', 'Oblique Twist', 'obliquetwist.png', 'Adjust one Functional Training Arm to its highest position and stand
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Core', 'Reverse Crunch', 'reversecrunch.png', 'Sit on the seat and grasp the handles, or sides of seat. Extend your legs to a
    horizontal position. Draw your knees toward your chest. Return slowly..' )

    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Leg', 'Leg Extension', 'legextension.png', 'Adjust the seat and the seat back so that, when seated, your knees are
    ...
    INSERT INTO exercise(body_part,exercise_name,photo,content) Values('Leg', 'Standing Leg Curl', 'standinglegcurl.png', 'Stand facing the machine. Adjust the seat so that the connected roller
